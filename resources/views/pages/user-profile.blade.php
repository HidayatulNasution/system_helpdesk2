...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Profile Management'])
    <div class="card shadow-lg mx-4 card-profile-bottom">
        <div class="card-body p-3">
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/icon1.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
