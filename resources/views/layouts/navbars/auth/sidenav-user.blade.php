<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">System Helpdesk user</span>
            <h6 class="text-center">Welcome {{ $username }}</h6>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Admin Tiket</span>
                </a>
            </li> --}}
            {{-- <li class="nav-item">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'manage-user') == true ? 'active' : '' }}"
                    href="{{ route('page', ['page' => 'manage-user']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
        ...
        <div class="card card-plain shadow-none" id="sidenavCard">
            ...
            <div class="card-body text-center p-3 w-100 pt-0">
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold mb-0">Please call administrator</p>
                </div>
            </div>
        </div>
        <a href="#" class="btn btn-dark btn-sm w-100 mb-3"></a>
        <a class="btn btn-primary btn-sm mb-0 w-100" href="#" type="button"></a>
    </div>
</aside>
