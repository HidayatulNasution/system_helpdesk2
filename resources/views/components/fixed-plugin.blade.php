<div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            {{-- <a class="btn bg-gradient-dark w-100" href="https://www.creative-tim.com/product/argon-dashboard-laravel"
                target="_blank">Free Download</a>
            <a class="btn btn-outline-dark w-100" href="/docs/bootstrap/overview/argon-dashboard/index.html"
