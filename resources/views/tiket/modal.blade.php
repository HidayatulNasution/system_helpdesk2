{{-- Modal Insert --}}
<div class="modal fade" id="ajax-tiket-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgba(0, 202, 238)">
                <h4 class="modal-title" id="tiketCrudModal"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="tiketForm" name="tiketForm" class="form-horizontal" enctype="multipart/form-data">
                    <div class="row">
