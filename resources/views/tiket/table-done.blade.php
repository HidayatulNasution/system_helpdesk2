<div class="w-full mt-7">
    ...
    <div class="w-full mt-2 mb-2">
        <div class="flex space-x-4">
            ...
            <button id="filter-button" class="bg-blue btn-success text-white px-4 py-2 rounded">🔍 Filter</button>
            ...
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="text-left py-4 px-3 uppercase font-semibold text-sm" style="min-width: 100px;">Tanggal
                        Entry</th>
                    <th class="text-left py-4 px-3 uppercase font-semibold text-sm">Username</th>
                    ...
                    <th class="text-left py-4 px-4 uppercase font-semibold text-sm" style="min-width:100px;">Tanggal
                        Selesai</th>
